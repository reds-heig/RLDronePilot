...
class Agent(object):
    ...
    def update_network_parameters(self, tau=None):
        ...
        #print('inside update_network_parameters')
        #print('critic', any(any(T.isnan(p).cpu().tolist()) for p in self.critic.parameters()))
        #print('target_critic', any(any(T.isnan(p).cpu().tolist()) for p in self.target_critic.parameters()))
        #print('actor', any(any(T.isnan(p).cpu().tolist()) for p in self.actor.parameters()))
        #print('target_actor', any(any(T.isnan(p).cpu().tolist()) for p in self.target_actor.parameters()))
